...
namespace ENB.Doctors.Practise.Infrastructure
{
  ...
  public interface IRepository<T, K> where T : class
  {
    ...
    /// <summary>
    /// Add a collection of entity from the underlying collection.
    /// </summary>
    /// <param name="entities">The entitis that should be added..</param>
    void AddRange(IEnumerable<T> entities);

    /// <summary>
    /// Removes a collection entity from the underlying collection.
    /// </summary>
    /// <param name="entities">The entitis that should be removed.</param>
